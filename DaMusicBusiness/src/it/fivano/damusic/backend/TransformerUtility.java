package it.fivano.damusic.backend;
...
import it.fivano.damusic.backend.model.ReleaseExtraction;
...
import it.fivano.damusic.model.VideoModel;
...
public class TransformerUtility {
	...
	public static Release transformRelease(ReleaseModel model) throws ParseException {
		...
		res.setReleaseDate(DamusicUtility.getStandardDate(model.getReleaseDate()));
	...
	public static ReleaseModel transformReleaseToModel(Release rel) throws ParseException {
		...
		res.setReleaseDate(DamusicUtility.getStandardDate(rel.getReleaseDate()));
	...
	public static StringKeyModel transformPopularKeyToModel(List<PopularKey> input) {
		if(input==null)
			return null;

		StringKeyModel res = new StringKeyModel();
		for(PopularKey pk : input) {
			res.addStringKey(pk.getStringKey(), pk.getCountRef());
		}
