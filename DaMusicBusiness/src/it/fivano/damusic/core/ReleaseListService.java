...
import it.fivano.damusic.backend.service.PopularKeyService;
import it.fivano.damusic.backend.service.ReleaseService;
import it.fivano.damusic.core.parser.ReleaseDetailsParser;
import it.fivano.damusic.core.parser.ReleaseListParser;
import it.fivano.damusic.core.parser.YoutubeParser;
import it.fivano.damusic.core.parser.model.BaseReleaseParserModel;
import it.fivano.damusic.core.utils.DamusicUtility;
import it.fivano.damusic.core.utils.SearchInput;
import it.fivano.damusic.core.utils.C.SearchType;
...
//			supp.setEnableYoutubeService(enableYoutubeService);
	...
	private ReleaseModel arricchisciRelease(BaseReleaseParserModel sc, ReleaseModel release) throws ParseException {
		...
		release.setGenre(DamusicUtility.creaGenere(sc.getGenre()));
		if(release.getReleaseDate()==null)
			release.setReleaseDate(DamusicUtility.getStandardDate(sc.getReleaseDate()));
		return release;
	}
